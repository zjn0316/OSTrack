class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = r"D:\OSTrack"    # Base directory for saving network checkpoints.
        self.tensorboard_dir = r"D:\OSTrack\tensorboard"    # Directory for tensorboard files.
